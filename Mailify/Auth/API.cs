                    ...
                    switch (response[2])
                    {
                        case "success":
                            ...
                            else
                            {
                                ...
                                {
                                    MessageBox.Show("Update Found, Starting Updater!", Name, MessageBoxButton.OK, MessageBoxImage.Error);
                                    try
                                    {
                                    ...
                                    {
                                        MessageBox.Show("Updater Not Found in Directory!", Name, MessageBoxButton.OK, MessageBoxImage.Error);
                                    }
                                    Process.GetCurrentProcess().Kill();
                                }
                ...
                try
                {
                    ...
                    switch (response[2])
                    {
                        case "success":
                            ...
                            return true;
                        case "invalid_details":
                            Print($"Email or Password Invalid!", PrintType.Error);
                            Thread.Sleep(2000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                        case "time_expired":
                            Print($"Your Subscription has expired", PrintType.Error);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                        case "hwid_updated":
                            Print($"Updated Hwid, Please Reopen", PrintType.Output);
                            Thread.Sleep(2000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                        case "invalid_hwid":
                            Print($"Incorrect Hwid, If you need a Hwid reset, Contact Admins", PrintType.Error);
                            Thread.Sleep(2000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                ...
                try
                {
                    ...
                    switch (response[2])
                    {
                        ...
                        case "invalid_license":
                            Print("License is Invalid", PrintType.Error);
                            Thread.Sleep(3000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                        case "email_used":
                            Print("Email already used (Please use a differnt email)", PrintType.Error);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                        case "invalid_username":
                            Print("Invalid/Used Username Entered", PrintType.Error);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                    }
